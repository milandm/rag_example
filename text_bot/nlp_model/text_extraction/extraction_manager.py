...
from text_bot.nlp_model.text_extraction.extractor_prompt_creator import ExtractionPromptCreator
...
class ExtractionManager:
    ...
    def process_document(self, extraction_document_path: str) -> dict:
        print(" ")
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ")
        print("extraction_document_path "+extraction_document_path)
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ")
        print(" ")

        extraction_document_path
