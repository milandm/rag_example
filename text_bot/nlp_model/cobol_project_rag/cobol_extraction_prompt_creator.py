...
from text_bot.nlp_model.cobol_project_rag.cobol_extraction_promt_template_creator import \
    CobolExtractionPromptTemplateCreator, \
    SYSTEM_MSG_TITLE, \
    TITLE_EXTRACT_KEY, \
...
class CobolExtractionPromptCreator:

    def __init__(self, nlp_model: NlpModel):
        self.model = nlp_model
        self.prompt_template_creator = CobolExtractionPromptTemplateCreator()
